    ...
    <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
            <a href="" class="text-nowrap logo-img">
                <img src="{{ asset('assets/general/logo/Logo-sidebar-v2.png') }}" alt="" width="198" height="30">
            </a>
                            ...
                            <div class="simplebar-content" style="padding: 0px 24px;">
                                <ul id="sidebarnav">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link has-arrow {{ isRouteActive('news.create') ? 'active' : (isRouteActive('news.edit') ? 'active' : '') }}" href="javascript:void(0)"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                        ...
                                        <ul aria-expanded="false" class="collapse first-level {{ isRouteActive('news.create') ? 'in' : (isRouteActive('news.edit') ? 'in' : '') }}">
                                            <li class="sidebar-item">
                                            ...
                                            <li class="sidebar-item">
                                                <a href="{{ route('news') }}" class="sidebar-link {{ isRouteActive('news.create') ? 'active' : (isRouteActive('news.edit') ? 'active' : '') }}">
                                                    <div
                                                        class="round-16 d-flex align-items-center justify-content-center">
                                                        <i class="ti ti-circle"></i>
                                                    </div>
                                    ...
                                    <li class="sidebar-item">
                                        ...
                                        <ul aria-expanded="false" class="collapse first-level {{ isRouteActive('ppid.files') ? 'in' : '' }}">
                                            <li class="sidebar-item">
                                            ...
                                            @foreach ($ppid_categories as $item)
                                                <li class="sidebar-item">
                                                    <a href="{{ route('ppid', ['id' => $item->id]) }}" class="sidebar-link">
                                                        <div
                                                            class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                                        </div>
