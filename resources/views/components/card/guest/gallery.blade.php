@props(['title', 'image', 'categoryName', 'date', 'detail'])

<div
    class="ed-2-single-course mix {{ filterClassFormat($categoryName) }} border border-[#e5e5e5] rounded-[10px] p-[20px] group">
    <!-- course image  -->
    ...
    <h5 class="font-semibold text-[20px] text-edblue mb-[23px] hover:text-edgreen line-clamp-2">
        <a href="{{ $detail }}">
            {{ $title }}
        </a>
    </h5>
