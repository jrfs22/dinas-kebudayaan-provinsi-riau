...
@section('content')
    ...
    <section class="ed-2-courses py-[120px] xl:py-[80px] md:py-[60px]">
        <div class="mx-[9.2%] xxxl:mx-[8.2%] xxl:mx-[3%]">
            ...
            >
                ...
                <button
                    class="hover:bg-edgreen hover:text-white"
                    data-filter=".pelestarian"
                >
                    Pelestarian
                </button>
                <button
            ...
            >
                ...
                <x-card.guest.news
                    ...
                    title="Dinas Kebudayaan Adakan Lomba Pelestarian Budaya"
                    slug="Mari ikut serta dalam lomba divelestarian budaya yang diselenggarakan ..."
                    author="admin disbud"
                    detail="detail-kegiatan-disbud.html"
                />
                ...
                <x-card.guest.news
                    ...
                    date="30 September 2024"
                    title="Dinas Kebudayaan Gelar Festival Seni Tradisional"
                    slug="Mari ikut serta dalam lomba divelestarian budaya yang diselenggarakan ..."
                    author="admin disbud"
                    detail="detail-kegiatan-disbud.html"
                />
                ...
                <x-card.guest.news
                    ...
                    date="30 September 2024"
                    title="Lomba Kreativitas Budaya Digelar oleh Dinas Kebudayaan"
                    slug="Mari ikut serta dalam lomba divelestarian budaya yang diselenggarakan ..."
                    author="admin disbud"
                    detail="detail-kegiatan-disbud.html"
                />
    ...
    <section
        ...
        <div
            class="mx-[19.7%] xxxl:mx-[14.7%] xxl:mx-[9.7%] xl:mx-[3.2%] md:mx-[15px]"
        >
            <div class="flex md:flex-col gap-x-[75px] gap-y-[30px]">
                ...
                <div class="max-w-[46%] md:max-w-full grow shrink-0">
                    <div class="relative flex items-end">
                        <img
                            src="{{ asset('assets/guest/img/about-2-image-1.png') }}"
                            alt="About Image"
                        ...
                        <div>
                            <img
                                src="{{ asset('assets/guest/img/about-2-img-vector.svg') }}"
                                alt="vector"
                                class="absolute pointer-events-none top-[60px] right-[65px] -z-[1]"
                            />
                            <img
                                src="{{ asset('assets/guest/img/about-2-img-vector-2.svg') }}"
                                alt="vector"
                ...
                <div class="max-w-[54%] md:max-w-full">
                    ...
                    <h2 class="ed-section-title mb-[6px]">
                        ...
                        <span
                            class="inline-block text-edgreen font-bold relative before:absolute before:left-0 before:top-[calc(100%-6px)] before:w-[137px] before:h-[14px] before:bg-[url('../assets/img/banner-2-title-vector.svg')] before:bg-[length:100%_100%]"
                            >Warisan Budaya</span
                        >
                        untuk Masa Depan
                    </h2>
    ...
    <section class="ed-2-events py-[120px] xl:py-[80px] md:py-[60px]">
        ...
        >
            ...
            >
                ...
                >
                    <button
                        class="prev hover:bg-edgreen hover:border-edpubg-edgreen hover:text-white"
                    >
                        <i class="fa-solid fa-angle-left"></i>
                    </button>
                    <button
                        class="next hover:bg-edgreen hover:border-edpubg-edgreen hover:text-white"
                    >
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide w-[50%]">
                        <div class="space-y-[30px]">
                            <x-card.guest.event
                                title="Festival Sanggar Tari dan Budaya Riau 1"
                                slug="Festival ini menampilkan seni tari dan budaya Riau untuk melestarikan tradisi lokal."
                                detail="detail-event-budaya.html"
                                image="{{ asset('assets/guest/img/event-4.jpg') }}"
                                time="09:00 - 12:00"
                            />
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide w-[50%]">
                        <div class="space-y-[30px]">
                            <x-card.guest.event
                                title="Festival Sanggar Tari dan Budaya Riau 2"
                                slug="Festival ini menampilkan seni tari dan budaya Riau untuk melestarikan tradisi lokal."
                                detail="detail-event-budaya.html"
                                image="{{ asset('assets/guest/img/event-4.jpg') }}"
                                time="09:00 - 12:00"
                    ...
                    <div class="swiper-slide w-[50%]">
                        <div class="space-y-[30px]">
                            <x-card.guest.event
                                title="Festival Sanggar Tari dan Budaya Riau 3"
                                slug="Festival ini menampilkan seni tari dan budaya Riau untuk melestarikan tradisi lokal."
                                detail="detail-event-budaya.html"
                                image="{{ asset('assets/guest/img/event-4.jpg') }}"
                                time="09:00 - 12:00"
        ...
        <div class="mx-[19.7%] xxxl:mx-[14.7%] xxl:mx-[9.7%] xl:mx-[3.2%] md:mx-[15px]">
            ...
            <div class="grid grid-cols-2 md:grid-cols-1 gap-[30px]">
                ...
                <div class="rounded-[20px] bg-edoffwhite overflow-hidden">
                    <!-- img -->
                    <div class="relative">
                        <img src="{{ asset('assets/guest/img/blog-big.jpg') }}" alt="blog cover" class="w-full aspect-[570/290]" />
                        <!-- date -->
                        <div
